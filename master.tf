...
resource "scaleway_server" "k8s_master" {
  ...
  image          = "${data.scaleway_image.masters_os_image.id}"
...
#
# resource "scaleway_volume" "k8s_master" {
#   name       = "k8s_master"
#   size_in_gb = 40
#   type       = "l_ssd"
# }
#
# resource "scaleway_volume_attachment" "k8s_master" {
#   server = "${scaleway_server.k8s_master.id}"
#   volume = "${scaleway_volume.k8s_master.id}"
#   depends_on = ["scaleway_server.k8s_master", "scaleway_volume.k8s_master"]
# }
